...
@router.post("/delete_student_enrollment", response_model=DeleteStudentEnrollmentResponseModel, summary="Delete a student's enrollment in a semester")
def delete_enrollment(student : DeleteStudentEnrollment) -> DeleteStudentEnrollmentResponseModel:
    """Delete a student's enrollment in a semester."""
    return delete_student_enrollment(student_id=student.student_id, sem_id=student.sem_id)